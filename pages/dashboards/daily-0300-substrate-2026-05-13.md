---
type: dashboard
id: DAILY-0300-SUBSTRATE-2026-05-13
title: "Daily 03:00 substrate sync - 2026-05-13"
date: 2026-05-13
captured_at: 2026-05-13T03:00:05.751229+05:00
status: green
...
# Daily 03:00 substrate sync - 2026-05-13
...
| Obsidian/wiki | `GREEN` | wiki clean at HEAD 4987b2c7 |
...
| Todoist/ControlPlane | `GREEN` | 217 active tasks; no-section=0; missing_owner=0; missing_department=0; default_priority=0; contextless=104; pending_actions=0 |
...
| wiki-sync final | `GREEN` | final sync after report write: /Users/madia/nous-agaas/wiki/pages/dashboards/daily-0300-substrate-2026-05-13.md |
...
```text
[2026-05-13-03-00-08] OK: rsync complete (0 files changed)
[2026-05-13-03-00-08] OK: _gbrain sync complete
[2026-05-13-03-00-08] OK: tools/ sync complete
[2026-05-13-03-00-08] OK: ~/.local/bin/ sync complete
[2026-05-13-03-00-08] OK: OpenClaw SOUL/USER/AGENTS runtime sync complete
[2026-05-13-03-00-08] OK: tenant/satory/skills/ sync complete
[2026-05-13-03-00-08] OK: tenant/gov-pilot/runtime-source sync complete
[2026-05-13-03-00-08] OK: tenant/satory/runtime-source sync complete
```
...
```text
33367	0	com.nous.daily-0300-substrate-sync
```

### Obsidian/wiki

- Status: `GREEN`
- Summary: wiki clean at HEAD 4987b2c7
...
```text
{
  ...
  "checks": [
    ...
    },
    {
      "name": "sync_failures",
      "status": "ok",
      "message": "13 historical sync failure(s), all acknowledged [UNKNOWN=13]."
    },
    {
      "name": "connection",
      "status": "ok",
      "message": "Connected, 3211 pages"
    },
    {
      "name": "pgvector",
      "status": "ok",
...
```text
com.nous.telegram-poll loaded and currently running pid=33214 last_exit=0
telegram_poll.lock age=40s
telegram_poll.err mtime=2026-05-12T18:49:07.215581+05:00
```

### Todoist/ControlPlane

- Status: `GREEN`
- Summary: 217 active tasks; no-section=0; missing_owner=0; missing_department=0; default_priority=0; contextless=104; pending_actions=0

```text
{
  "counts": {
    "active_root_tasks": 169,
    "active_subtasks": 48,
    "active_tasks": 217,
    "labels": 23,
    "note_file_attachments": 6,
    "notes": 21,
    "projects": 11,
    "sections": 16
  },
...
51270 last_state=0
2026-05-12T20:25:17Z OK pcap=wg0-collector.pcap size=338719127 delta=+75078426 last_state=0
2026-05-12T20:30:19Z OK pcap=wg0-collector.pcap size=414729458 delta=+76010331 last_state=0
2026-05-12T20:35:21Z OK pcap=wg0-collector.pcap size=477073311 delta=+62343853 last_state=0
2026-05-12T20:40:23Z OK pcap=wg0-collector.pcap size=530568811 delta=+53495500 last_state=0
2026-05-12T20:45:25Z OK pcap=wg0-collector.pcap size=578020389 delta=+47451578 last_state=0
2026-05-12T20:50:27Z OK pcap=wg0-collector.pcap size=639534507 delta=+61514118 last_state=0
2026-05-12T20:55:29Z OK pcap=wg0-collector.pcap size=691163535 delta=+51629028 last_state=0
2026-05-12T21:00:31Z OK pcap=wg0-collector.pcap size=647455 previous_size=691163535 (truncated/rotated — delta baseline reset)
2026-05-12T21:05:33Z OK pcap=wg0-collector.pcap size=58003368 delta=+57355913 last_state=0
2026-05-12T21:10:35Z OK pcap=wg0-collector.pcap size=118004553 delta=+60001185 last_state=0
2026-05-12T21:15:41Z OK pcap=wg0-collector.pcap size=179308121 delta=+61303568 last_state=0
2026-05-12T21:20:45Z OK pcap=wg0-collector.pcap size=209425843 delta=+30117722 last_state=0
2026-05-12T21:25:49Z OK pcap=wg0-collector.pcap size=252865837 delta=+43439994 last_state=0
2026-05-12T21:30:53Z OK pcap=wg0-collector.pcap size=297598659 delta=+44732822 last_state=0
2026-05-12T21:35:57Z OK pcap=wg0-collector.pcap size=345700403 delta=+48101744 last_state=0
2026-05-12T21:40:59Z OK pcap=wg0-collector.pcap size=392656832 delta=+46956429 last_state=0
2026-05-12T21:46:01Z OK pcap=wg0-collector.pcap size=433215397 delta=+40558565 last_state=0
2026-05-12T21:51:03Z OK pcap=wg0-collector.pcap size=473528132 delta=+40312735 last_state=0
2026-05-12T21:56:05Z OK pcap=wg0-collector.pcap size=513737235 delta=+40209103 last_state=0
```

### wiki-sync final

- Status: `GREEN`
- Summary: final sync after report write: /Users/madia/nous-agaas/wiki/pages/dashboards/daily-0300-substrate-2026-05-13.md
- Exit / HTTP code: `0`
...
After doing this, you may fix the identity used for this commit with:
 ...
 create mode 100644 pages/dashboards/daily-0300-substrate-2026-05-13.md
Already up to date.
