...
Modes:
  ...
  --emit              print only the injection block (for hook consumption)
...
FACTS = REPO / "pages" / "mercury" / "facts.jsonl"
...
def emit_block(selected: list[dict]) -> str:
    ...
    lines = fm + [_now_context().rstrip(), "", "# Mercury fact-block (top-K selective injection)", ""]
